...
class SVDHead(nn.Module):
    ...
    def forward(self, *input):
        ...
        return R, t.view(batch_size, 3), src_corr, scores
...
class MultiCON(nn.Module):
    ...
    def forward(self, *input):
        ...
        rotation_ab, translation_ab, src_corr, scores = self.head(src_embedding, tgt_embedding, src, tgt)
        if self.cycle:
        ...
        return rotation_ab, translation_ab, src_corr, scores
